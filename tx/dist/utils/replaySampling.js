...
const SERIALIZED_TRANSACTION_ENCODING = 'base64';
/**
 * Report a transaction sample to the Kamino API
 * @param serializedTransaction - The serialized transaction buffer
 * @param description - The description of the transaction
 */
export async function reportTransactionSample(serializedTransaction, description) {
    try {
...
//# sourceMappingURL=replaySampling.js.map