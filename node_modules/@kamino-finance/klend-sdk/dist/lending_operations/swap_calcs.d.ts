...
export type CalculateSwapCollExpectedOutputInputs = CalculateSwapCollExpectedOutputInputsCollFlow | CalculateSwapCollExpectedOutputInputsDebtFlow;
/**
 ...
 */
export declare function getSlippageFactor(slippagePct: Decimal): Decimal;
/**
 ...
 */
export declare function assertPositiveFiniteDecimal(name: string, value: Decimal): void;
/**
 ...
 */
export declare const VIA_DEBT_DUST_SAFETY_FACTOR: Decimal;
 ...
 */
export declare function sizeViaDebtFlashBorrow(params: {
 ...
 */
export declare function calculateSwapCollExpectedOutput(inputs: CalculateSwapCollExpectedOutputInputs): SwapCollExpectedOutput;
/**
 ...
 */
export declare function calculateSwapDebtExpectedOutput(inputs: CalculateSwapDebtExpectedOutputInputs): SwapDebtExpectedOutput;
export {};
//# sourceMappingURL=swap_calcs.d.ts.map