...
exports.resolveSourceDebtRepayLamports = resolveSourceDebtRepayLamports;
exports.resolveSourceDebtEarlyRepayPenaltyLamports = resolveSourceDebtEarlyRepayPenaltyLamports;
 ...
 */
function resolveSourceDebtRepayLamports(params) {
    const { market, obligation, sourceDebtReserve, isClosingSourceDebt, sourceDebtSwapAmount, currentLedgerInstant } = params;
    if (isClosingSourceDebt) {
        ...
        const irRatio = obligation
            ...
            .toDecimalPlaces(sourceDebtReserve.state.liquidity.mintDecimals.toNumber(), decimal_js_1.default.ROUND_CEIL);
        const irMultiplier = irRatio.lte(0) ? new decimal_js_1.default('1.001') : irRatio.mul(new decimal_js_1.default('1.001'));
        return obligation
            .getBorrowAmountByReserve(sourceDebtReserve)
            .mul(sourceDebtReserve.getMintFactor())
            .mul(irMultiplier)
            .toDecimalPlaces(0, decimal_js_1.default.ROUND_CEIL);
    }
 ...
 */
function resolveSourceDebtEarlyRepayPenaltyLamports(params) {
...
//# sourceMappingURL=swap_debt_sizing.js.map