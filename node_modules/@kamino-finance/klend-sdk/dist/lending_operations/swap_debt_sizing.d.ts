 ...
 */
export declare function resolveSourceDebtRepayLamports(params: {
    market: KaminoMarket;
 ...
 */
export declare function resolveSourceDebtEarlyRepayPenaltyLamports(params: {
    obligation: KaminoObligation;
    sourceDebtReserve: KaminoReserve;
    repayPrincipalLamports: Decimal;
    currentLedgerInstant: LedgerInstant;
}): Decimal;
//# sourceMappingURL=swap_debt_sizing.d.ts.map