...
exports.REDEEM_DRIFT_FACTOR = void 0;
exports.bufferWithdrawForRedeemDrift = bufferWithdrawForRedeemDrift;
exports.haircutPullForRedeemDrift = haircutPullForRedeemDrift;
exports.sizeRedeemFundedPull = sizeRedeemFundedPull;
exports.redeemWithdrawAmount = redeemWithdrawAmount;
 ...
 */
exports.REDEEM_DRIFT_FACTOR = new decimal_js_1.default('0.000001');
const BUFFER_FACTOR = new decimal_js_1.default(1).add(exports.REDEEM_DRIFT_FACTOR);
const HAIRCUT_FACTOR = new decimal_js_1.default(1).sub(exports.REDEEM_DRIFT_FACTOR);
/**
 ...
 */
function bufferWithdrawForRedeemDrift(withdrawLamports, maxWithdrawLamports) {
    const buffered = withdrawLamports.mul(BUFFER_FACTOR).ceil();
    return maxWithdrawLamports !== undefined ? decimal_js_1.default.min(buffered, maxWithdrawLamports) : buffered;
}
/**
 ...
 */
function haircutPullForRedeemDrift(pullLamports) {
 ...
 * ternary.
 */
function sizeRedeemFundedPull(pullLamports, isClosing) {
 ...
 */
function redeemWithdrawAmount(pullLamports, isClosing, maxWithdrawLamports) {
    return isClosing ? U64_MAX_STRING : bufferWithdrawForRedeemDrift(pullLamports, maxWithdrawLamports).toFixed(0);
}
//# sourceMappingURL=redeem_drift.js.map