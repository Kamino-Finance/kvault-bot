...
function buildReserveConfig(fields) {
    const reserveConfigFields = {
        ...
        emergencyMode: 0,
        rewardsAmountPerAccrualUnit: new bn_js_1.default(0),
        permissionedOps: new bn_js_1.default(0),
    };
