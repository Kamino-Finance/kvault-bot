...
async function getUserObligationsInMarkets(rpc, user, markets, currentLedgerInstant, commitment = 'processed', programId = programId_1.PROGRAM_ID) {
    ...
    for (const obligation of obligations) {
        ...
        classes_1.KaminoObligation.addRatesForObligation(market, obligationAccount.deposits, obligationAccount.borrows, collateralExchangeRates, cumulativeBorrowRates, currentLedgerInstant);
