...
exports.EVENT_AUTHORITY_SEED = exports.BASE_SEED_FARM_USER_STATE = exports.BASE_SEED_USER_STATE = exports.OWNER_QUEUED_COLLATERAL_VAULT_SEED = exports.WITHDRAW_TICKET_SEED = exports.BASE_SEED_GLOBAL_CONFIG_STATE = exports.BASE_SEED_SHORT_URL = exports.BASE_SEED_REFERRER_STATE = exports.BASE_SEED_REFERRER_TOKEN_STATE = exports.BASE_SEED_USER_METADATA = exports.RESERVE_COLL_SUPPLY_SEED = exports.RESERVE_COLL_MINT_SEED = exports.FEE_RECEIVER_SEED = exports.RESERVE_LIQ_SUPPLY_SEED = exports.LENDING_MARKET_AUTH_SEED = void 0;
...
exports.withdrawTicketPda = withdrawTicketPda;
exports.ownerQueuedCollateralVaultPda = ownerQueuedCollateralVaultPda;
 ...
 */
exports.WITHDRAW_TICKET_SEED = 'withdraw_ticket';
/**
 * Owner queued collateral vault seed
 */
exports.OWNER_QUEUED_COLLATERAL_VAULT_SEED = 'owner_queued_collateral_vault';
/**
 ...
 * @returns pda
 */
async function obligationFarmStatePda(farm, obligation, farmsProgramId = farms_sdk_1.FARMS_PROGRAM_ADDRESS) {
    const [address] = await (0, kit_1.getProgramDerivedAddress)({
 ...
 * @returns pda
 */
async function withdrawTicketPda(reserve, sequenceNumber, programId = programId_1.PROGRAM_ID) {
    const sequenceNumberBuffer = buffer_1.Buffer.alloc(8);
    sequenceNumberBuffer.writeBigUInt64LE(sequenceNumber);
    const [address] = await (0, kit_1.getProgramDerivedAddress)({
        seeds: [buffer_1.Buffer.from(exports.WITHDRAW_TICKET_SEED), addressEncoder.encode(reserve), sequenceNumberBuffer],
        programAddress: programId,
    });
    return address;
}
 ...
 * @returns pda
 */
async function ownerQueuedCollateralVaultPda(reserve, owner, programId = programId_1.PROGRAM_ID) {
    const [address] = await (0, kit_1.getProgramDerivedAddress)({
        seeds: [
            buffer_1.Buffer.from(exports.OWNER_QUEUED_COLLATERAL_VAULT_SEED),
            addressEncoder.encode(reserve),
 ...
 */
async function getEventAuthorityPda(programId) {
    const [address] = await (0, kit_1.getProgramDerivedAddress)({
        seeds: [buffer_1.Buffer.from(exports.EVENT_AUTHORITY_SEED)],
        programAddress: programId,
    });
    return address;
}
