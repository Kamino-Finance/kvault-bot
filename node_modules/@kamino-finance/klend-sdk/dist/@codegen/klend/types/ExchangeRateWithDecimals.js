...
exports.ExchangeRateWithDecimals = void 0;
const bn_js_1 = __importDefault(require("bn.js")); // eslint-disable-line @typescript-eslint/no-unused-vars
const borsh = __importStar(require("@coral-xyz/borsh"));
class ExchangeRateWithDecimals {
    exchangeRateSf;
    mintDecimals;
    constructor(fields) {
    ...
    static layout(property) {
        return borsh.struct([borsh.u128("exchangeRateSf"), borsh.u8("mintDecimals")], property);
    }
    ...
    static fromJSON(obj) {
        return new ExchangeRateWithDecimals({
            exchangeRateSf: new bn_js_1.default(obj.exchangeRateSf),
            mintDecimals: obj.mintDecimals,
        });
    }
    toEncodable() {
...
exports.ExchangeRateWithDecimals = ExchangeRateWithDecimals;
//# sourceMappingURL=ExchangeRateWithDecimals.js.map