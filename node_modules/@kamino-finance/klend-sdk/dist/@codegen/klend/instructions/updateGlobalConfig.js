...
exports.DISCRIMINATOR = Buffer.from([164, 84, 130, 189, 111, 58, 250, 200]);
exports.layout = borsh.struct([
    types.UpdateGlobalConfigMode.layout("mode"),
    borsh.vecU8("value"),
]);
function updateGlobalConfig(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
        {
