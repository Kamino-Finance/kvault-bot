...
exports.updateObligationConfig = updateObligationConfig;
/* eslint-disable @typescript-eslint/no-unused-vars */
const kit_1 = require("@solana/kit");
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const types = __importStar(require("../types")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
exports.DISCRIMINATOR = Buffer.from([82, 152, 213, 69, 250, 0, 157, 188]);
exports.layout = borsh.struct([
    types.UpdateObligationConfigMode.layout("mode"),
    borsh.vecU8("value"),
]);
function updateObligationConfig(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
        { address: accounts.owner.address, role: 2, signer: accounts.owner },
        { address: accounts.obligation, role: 1 },
        (0, kit_1.isSome)(accounts.borrowReserve)
            ? { address: accounts.borrowReserve.value, role: 0 }
            : { address: programAddress, role: 0 },
        (0, kit_1.isSome)(accounts.depositReserve)
...
//# sourceMappingURL=updateObligationConfig.js.map