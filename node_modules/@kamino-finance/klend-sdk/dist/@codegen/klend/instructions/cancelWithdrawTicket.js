...
exports.cancelWithdrawTicket = cancelWithdrawTicket;
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
exports.DISCRIMINATOR = Buffer.from([180, 83, 122, 44, 120, 211, 47, 22]);
exports.layout = borsh.struct([
    borsh.u64("ticketSequenceNumber"),
    borsh.u64("collateralAmountToCancel"),
]);
function cancelWithdrawTicket(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
...
//# sourceMappingURL=cancelWithdrawTicket.js.map