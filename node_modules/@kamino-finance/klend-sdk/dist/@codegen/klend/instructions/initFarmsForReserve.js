...
exports.DISCRIMINATOR = Buffer.from([218, 6, 62, 233, 1, 33, 232, 82]);
exports.layout = borsh.struct([borsh.u8("mode")]);
function initFarmsForReserve(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
        {
