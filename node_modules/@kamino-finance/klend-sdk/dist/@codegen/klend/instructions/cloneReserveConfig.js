...
exports.cloneReserveConfig = cloneReserveConfig;
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const types = __importStar(require("../types")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
exports.DISCRIMINATOR = Buffer.from([244, 5, 198, 113, 17, 10, 71, 33]);
exports.layout = borsh.struct([
    types.ReserveConfigCustomizationArgs.layout("customizations"),
]);
function cloneReserveConfig(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
    ...
    const len = exports.layout.encode({
        customizations: types.ReserveConfigCustomizationArgs.toEncodable(args.customizations),
    }, buffer);
    const data = Buffer.concat([exports.DISCRIMINATOR, buffer]).slice(0, 8 + len);
    const ix = { accounts: keys, programAddress, data };
    return ix;
}
//# sourceMappingURL=cloneReserveConfig.js.map