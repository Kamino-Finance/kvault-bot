...
exports.topupReserveRewards = topupReserveRewards;
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
exports.DISCRIMINATOR = Buffer.from([63, 255, 130, 211, 110, 216, 88, 173]);
exports.layout = borsh.struct([
    borsh.u64("amount"),
]);
function topupReserveRewards(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
...
//# sourceMappingURL=topupReserveRewards.js.map