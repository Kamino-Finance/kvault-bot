...
exports.withdrawProtocolFee = withdrawProtocolFee;
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
exports.DISCRIMINATOR = Buffer.from([158, 201, 158, 189, 33, 93, 162, 103]);
exports.layout = borsh.struct([
    borsh.u64("amount"),
]);
function withdrawProtocolFee(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
...
//# sourceMappingURL=withdrawProtocolFee.js.map