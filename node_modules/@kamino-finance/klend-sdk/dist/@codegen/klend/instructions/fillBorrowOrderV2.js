...
exports.fillBorrowOrderV2 = fillBorrowOrderV2;
/* eslint-disable @typescript-eslint/no-unused-vars */
const kit_1 = require("@solana/kit");
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
exports.DISCRIMINATOR = Buffer.from([197, 85, 193, 139, 40, 94, 194, 143]);
exports.layout = borsh.struct([borsh.u8("orderIdx")]);
function fillBorrowOrderV2(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
        {
...
//# sourceMappingURL=fillBorrowOrderV2.js.map