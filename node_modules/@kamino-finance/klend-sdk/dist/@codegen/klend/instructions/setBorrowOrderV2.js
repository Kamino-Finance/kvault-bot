...
exports.setBorrowOrderV2 = setBorrowOrderV2;
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const types = __importStar(require("../types")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
exports.DISCRIMINATOR = Buffer.from([87, 255, 30, 4, 156, 230, 167, 126]);
exports.layout = borsh.struct([
    borsh.u8("orderIdx"),
    types.BorrowOrderConfigArgs.layout("orderConfig"),
    borsh.u64("minExpectedCurrentRemainingDebtAmount"),
]);
function setBorrowOrderV2(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
...
//# sourceMappingURL=setBorrowOrderV2.js.map