...
exports.DISCRIMINATOR = Buffer.from([164, 35, 182, 19, 0, 116, 243, 127]);
exports.layout = borsh.struct([
    borsh.u8("autodeleverageTargetLtvPct"),
]);
function markObligationForDeleveraging(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
        {
