...
class ObligationZP {
    ...
    static layout = borsh.struct([
        ...
        (0, utils_1.borshAddress)("pendingOwner"),
    ...
    constructor(fields) {
        ...
        this.tailBorrowOrders = fields.tailBorrowOrders.map((item) => new types.BorrowOrder({ ...item }));
    ...
    static decode(data) {
        ...
        return new accounts_1.Obligation({
            ...
            tailBorrowOrders: dec.tailBorrowOrders.map((item /* eslint-disable-line @typescript-eslint/no-explicit-any */) => types.BorrowOrder.fromDecoded(item)),
            padding3: [],
        });
    }
}
