...
exports.buyWithMinSharesOut = buyWithMinSharesOut;
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
exports.DISCRIMINATOR = Buffer.from([61, 135, 102, 151, 124, 46, 144, 209]);
exports.layout = borsh.struct([
    borsh.u64("maxAmount"),
    borsh.u64("minSharesOut"),
]);
function buyWithMinSharesOut(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
...
//# sourceMappingURL=buyWithMinSharesOut.js.map