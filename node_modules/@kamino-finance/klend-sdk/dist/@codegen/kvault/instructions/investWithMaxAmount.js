...
exports.investWithMaxAmount = investWithMaxAmount;
/* eslint-disable @typescript-eslint/no-unused-vars */
const kit_1 = require("@solana/kit");
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
exports.DISCRIMINATOR = Buffer.from([135, 92, 184, 137, 69, 72, 118, 7]);
exports.layout = borsh.struct([
    borsh.u64("maxAmount"),
]);
function investWithMaxAmount(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
...
//# sourceMappingURL=investWithMaxAmount.js.map