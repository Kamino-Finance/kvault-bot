...
exports.depositWithMinSharesOut = depositWithMinSharesOut;
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
exports.DISCRIMINATOR = Buffer.from([74, 127, 128, 80, 4, 221, 193, 91]);
exports.layout = borsh.struct([
    borsh.u64("maxAmount"),
    borsh.u64("minSharesOut"),
]);
function depositWithMinSharesOut(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
