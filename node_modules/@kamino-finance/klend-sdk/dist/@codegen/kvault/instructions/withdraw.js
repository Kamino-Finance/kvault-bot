...
exports.DISCRIMINATOR = Buffer.from([183, 18, 70, 156, 148, 109, 161, 34]);
exports.layout = borsh.struct([borsh.u64("sharesAmount")]);
function withdraw(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
        {
        ...
        {
            address: accounts.withdrawFromReserveAccounts.reserveCollateralTokenProgram,
            role: 0,
        },
        {
