...
exports.withdrawFromAvailable = withdrawFromAvailable;
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
exports.DISCRIMINATOR = Buffer.from([19, 131, 112, 155, 170, 220, 34, 57]);
exports.layout = borsh.struct([
    borsh.u64("sharesAmount"),
]);
function withdrawFromAvailable(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
...
//# sourceMappingURL=withdrawFromAvailable.js.map