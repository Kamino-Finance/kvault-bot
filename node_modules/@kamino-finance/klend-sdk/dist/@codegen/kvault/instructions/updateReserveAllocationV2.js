...
exports.updateReserveAllocationV2 = updateReserveAllocationV2;
/* eslint-disable @typescript-eslint/no-unused-vars */
const kit_1 = require("@solana/kit");
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
exports.DISCRIMINATOR = Buffer.from([195, 136, 1, 79, 10, 123, 121, 100]);
exports.layout = borsh.struct([
    borsh.u64("weight"),
    borsh.u64("cap"),
    borsh.u64("ctokenAllocationCap"),
]);
function updateReserveAllocationV2(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
...
//# sourceMappingURL=updateReserveAllocationV2.js.map