...
class VaultDepositCapReached extends Error {
    logs;
    static code = 7062;
    code = 7062;
...
exports.VaultDepositCapReached = VaultDepositCapReached;
class MaxInvestAmountMustBeGreaterThanZero extends Error {
    logs;
    static code = 7063;
    code = 7063;
    name = "MaxInvestAmountMustBeGreaterThanZero";
...
exports.MaxInvestAmountMustBeGreaterThanZero = MaxInvestAmountMustBeGreaterThanZero;
class SharesOutBelowMinimum extends Error {
    logs;
    static code = 7064;
    code = 7064;
    name = "SharesOutBelowMinimum";
...
exports.SharesOutBelowMinimum = SharesOutBelowMinimum;
