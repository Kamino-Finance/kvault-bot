...
class ReserveConfig {
    ...
    static fromJSON(obj) {
        return new ReserveConfig({
            ...
            debtTermSeconds: new bn_js_1.default(obj.debtTermSeconds),
            rewardsAmountPerSlot: new bn_js_1.default(obj.rewardsAmountPerSlot),
            permissionedOps: new bn_js_1.default(obj.permissionedOps),
        });
    }
    toEncodable() {
