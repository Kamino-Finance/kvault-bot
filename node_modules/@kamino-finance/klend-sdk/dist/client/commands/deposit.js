...
async function deposit(env, mode, reserveAddress, depositAmount, marketAddress) {
    ...
    const kaminoAction = await classes_1.KaminoAction.buildDepositTxns({
        kaminoMarket,
