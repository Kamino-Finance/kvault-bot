...
async function initFarmsForReserve(env, mode, reserve, kind) {
    ...
    const market = await src_1.KaminoMarket.load(env.c.rpc, lendingMarket, src_1.DEFAULT_RECENT_SLOT_DURATION_MS, // no reserves loaded (withReserves=false below) - the slot duration plays no role
    env.klendProgramId, false);
    if (!market) {
