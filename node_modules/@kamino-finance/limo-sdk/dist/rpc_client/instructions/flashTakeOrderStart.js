...
exports.flashTakeOrderStart = flashTakeOrderStart;
/* eslint-disable @typescript-eslint/no-unused-vars */
const kit_1 = require("@solana/kit");
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
exports.DISCRIMINATOR = Buffer.from([126, 53, 176, 15, 39, 103, 97, 243]);
exports.layout = borsh.struct([
    borsh.u64("inputAmount"),
    borsh.u64("minOutputAmount"),
    borsh.u64("tipAmountPermissionlessTaking"),
]);
function flashTakeOrderStart(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
        ...
        (0, kit_1.isSome)(accounts.intermediaryOutputTokenAccount)
            ? { address: accounts.intermediaryOutputTokenAccount.value, role: 1 }
            : { address: programAddress, role: 0 },
        (0, kit_1.isSome)(accounts.makerOutputAta)
        ...
        (0, kit_1.isSome)(accounts.permission)
...
//# sourceMappingURL=flashTakeOrderStart.js.map