...
exports.DISCRIMINATOR = Buffer.from([54, 8, 208, 207, 34, 134, 239, 168]);
exports.layout = borsh.struct([
    borsh.u16("mode"),
    borsh.vecU8("value"),
]);
function updateOrder(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
