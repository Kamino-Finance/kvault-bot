...
exports.INITIALIZE_POSITION_BUNDLE_WITH_METADATA_DISCRIMINATOR = void 0;
exports.getInitializePositionBundleWithMetadataDiscriminatorBytes = getInitializePositionBundleWithMetadataDiscriminatorBytes;
exports.getInitializePositionBundleWithMetadataInstructionDataEncoder = getInitializePositionBundleWithMetadataInstructionDataEncoder;
exports.getInitializePositionBundleWithMetadataInstructionDataDecoder = getInitializePositionBundleWithMetadataInstructionDataDecoder;
exports.getInitializePositionBundleWithMetadataInstructionDataCodec = getInitializePositionBundleWithMetadataInstructionDataCodec;
exports.getInitializePositionBundleWithMetadataInstruction = getInitializePositionBundleWithMetadataInstruction;
exports.parseInitializePositionBundleWithMetadataInstruction = parseInitializePositionBundleWithMetadataInstruction;
const kit_1 = require("@solana/kit");
const programs_1 = require("../programs");
const shared_1 = require("../shared");
exports.INITIALIZE_POSITION_BUNDLE_WITH_METADATA_DISCRIMINATOR = new Uint8Array([93, 124, 16, 179, 249, 131, 115, 245]);
function getInitializePositionBundleWithMetadataDiscriminatorBytes() { return (0, kit_1.fixEncoderSize)((0, kit_1.getBytesEncoder)(), 8).encode(exports.INITIALIZE_POSITION_BUNDLE_WITH_METADATA_DISCRIMINATOR); }
function getInitializePositionBundleWithMetadataInstructionDataEncoder() {
    return (0, kit_1.transformEncoder)((0, kit_1.getStructEncoder)([['discriminator', (0, kit_1.fixEncoderSize)((0, kit_1.getBytesEncoder)(), 8)]]), (value) => ({ ...value, discriminator: exports.INITIALIZE_POSITION_BUNDLE_WITH_METADATA_DISCRIMINATOR }));
}
...
function getInitializePositionBundleWithMetadataInstructionDataCodec() {
    return (0, kit_1.combineCodec)(getInitializePositionBundleWithMetadataInstructionDataEncoder(), getInitializePositionBundleWithMetadataInstructionDataDecoder());
}
...
//# sourceMappingURL=initializePositionBundleWithMetadata.js.map