...
export declare const AMM_V3_ERROR__INVAILD_TICK_INDEX = 6006;
/** TickInvaildOrder: The lower tick must be below the upper tick */
export declare const AMM_V3_ERROR__TICK_INVAILD_ORDER = 6007;
...
export declare const AMM_V3_ERROR__INVAILD_LIQUIDITY = 6017;
...
export declare const AMM_V3_ERROR__INVAILD_SWAP_AMOUNT_SPECIFIED = 6024;
...
export declare const AMM_V3_ERROR__EXCEPT_POOL_VAULT_MINT = 6032;
