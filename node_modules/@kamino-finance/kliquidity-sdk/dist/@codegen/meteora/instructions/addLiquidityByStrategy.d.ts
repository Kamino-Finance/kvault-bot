...
import { type StrategyParameters, type StrategyParametersArgs } from '../types';
export declare const ADD_LIQUIDITY_BY_STRATEGY_DISCRIMINATOR: Uint8Array<ArrayBuffer>;
export declare function getAddLiquidityByStrategyDiscriminatorBytes(): ReadonlyUint8Array;
...
export declare function getAddLiquidityByStrategyInstructionDataEncoder(): FixedSizeEncoder<AddLiquidityByStrategyInstructionDataArgs>;
export declare function getAddLiquidityByStrategyInstructionDataDecoder(): FixedSizeDecoder<AddLiquidityByStrategyInstructionData>;
export declare function getAddLiquidityByStrategyInstructionDataCodec(): FixedSizeCodec<AddLiquidityByStrategyInstructionDataArgs, AddLiquidityByStrategyInstructionData>;
...
export declare function parseAddLiquidityByStrategyInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(instruction: Instruction<TProgram> & InstructionWithAccounts<TAccountMetas> & InstructionWithData<ReadonlyUint8Array>): ParsedAddLiquidityByStrategyInstruction<TProgram, TAccountMetas>;
//# sourceMappingURL=addLiquidityByStrategy.d.ts.map