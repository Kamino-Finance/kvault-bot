...
import { type BinLiquidityDistributionByWeight, type BinLiquidityDistributionByWeightArgs } from '../types';
export declare const ADD_LIQUIDITY_BY_WEIGHT_DISCRIMINATOR: Uint8Array<ArrayBuffer>;
export declare function getAddLiquidityByWeightDiscriminatorBytes(): ReadonlyUint8Array;
...
export declare function getAddLiquidityByWeightInstructionDataEncoder(): Encoder<AddLiquidityByWeightInstructionDataArgs>;
export declare function getAddLiquidityByWeightInstructionDataDecoder(): Decoder<AddLiquidityByWeightInstructionData>;
export declare function getAddLiquidityByWeightInstructionDataCodec(): Codec<AddLiquidityByWeightInstructionDataArgs, AddLiquidityByWeightInstructionData>;
...
export declare function parseAddLiquidityByWeightInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(instruction: Instruction<TProgram> & InstructionWithAccounts<TAccountMetas> & InstructionWithData<ReadonlyUint8Array>): ParsedAddLiquidityByWeightInstruction<TProgram, TAccountMetas>;
