...
exports.ADD_LIQUIDITY_DISCRIMINATOR = void 0;
...
exports.ADD_LIQUIDITY_DISCRIMINATOR = new Uint8Array([181, 157, 89, 67, 143, 182, 52, 72]);
function getAddLiquidityDiscriminatorBytes() { return (0, kit_1.fixEncoderSize)((0, kit_1.getBytesEncoder)(), 8).encode(exports.ADD_LIQUIDITY_DISCRIMINATOR); }
...
function getAddLiquidityInstructionDataDecoder() {
    return (0, kit_1.getStructDecoder)([['discriminator', (0, kit_1.fixDecoderSize)((0, kit_1.getBytesDecoder)(), 8)], ['amountX', (0, kit_1.getU64Decoder)()], ['amountY', (0, kit_1.getU64Decoder)()], ['binLiquidityDist', (0, kit_1.getArrayDecoder)((0, types_1.getBinLiquidityDistributionDecoder)())]]);
}
function getAddLiquidityInstructionDataCodec() {
    return (0, kit_1.combineCodec)(getAddLiquidityInstructionDataEncoder(), getAddLiquidityInstructionDataDecoder());
}
function getAddLiquidityInstruction(input, config) {
    ...
    return Object.freeze({ accounts: [getAccountMeta(accounts.position), getAccountMeta(accounts.lbPair), getAccountMeta(accounts.binArrayBitmapExtension), getAccountMeta(accounts.userTokenX), getAccountMeta(accounts.userTokenY), getAccountMeta(accounts.reserveX), getAccountMeta(accounts.reserveY), getAccountMeta(accounts.tokenXMint), getAccountMeta(accounts.tokenYMint), getAccountMeta(accounts.binArrayLower), getAccountMeta(accounts.binArrayUpper), getAccountMeta(accounts.sender), getAccountMeta(accounts.tokenXProgram), getAccountMeta(accounts.tokenYProgram), getAccountMeta(accounts.eventAuthority), getAccountMeta(accounts.program)], data: getAddLiquidityInstructionDataEncoder().encode(args), programAddress });
}
