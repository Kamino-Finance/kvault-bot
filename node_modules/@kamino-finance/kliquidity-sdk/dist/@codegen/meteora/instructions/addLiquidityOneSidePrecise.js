...
exports.ADD_LIQUIDITY_ONE_SIDE_PRECISE_DISCRIMINATOR = void 0;
exports.getAddLiquidityOneSidePreciseDiscriminatorBytes = getAddLiquidityOneSidePreciseDiscriminatorBytes;
exports.getAddLiquidityOneSidePreciseInstructionDataEncoder = getAddLiquidityOneSidePreciseInstructionDataEncoder;
exports.getAddLiquidityOneSidePreciseInstructionDataDecoder = getAddLiquidityOneSidePreciseInstructionDataDecoder;
exports.getAddLiquidityOneSidePreciseInstructionDataCodec = getAddLiquidityOneSidePreciseInstructionDataCodec;
exports.getAddLiquidityOneSidePreciseInstruction = getAddLiquidityOneSidePreciseInstruction;
exports.parseAddLiquidityOneSidePreciseInstruction = parseAddLiquidityOneSidePreciseInstruction;
const kit_1 = require("@solana/kit");
const programs_1 = require("../programs");
const shared_1 = require("../shared");
const types_1 = require("../types");
exports.ADD_LIQUIDITY_ONE_SIDE_PRECISE_DISCRIMINATOR = new Uint8Array([161, 194, 103, 84, 171, 71, 250, 154]);
function getAddLiquidityOneSidePreciseDiscriminatorBytes() { return (0, kit_1.fixEncoderSize)((0, kit_1.getBytesEncoder)(), 8).encode(exports.ADD_LIQUIDITY_ONE_SIDE_PRECISE_DISCRIMINATOR); }
function getAddLiquidityOneSidePreciseInstructionDataEncoder() {
...
function getAddLiquidityOneSidePreciseInstructionDataDecoder() {
    return (0, kit_1.getStructDecoder)([['discriminator', (0, kit_1.fixDecoderSize)((0, kit_1.getBytesDecoder)(), 8)], ['bins', (0, kit_1.getArrayDecoder)((0, types_1.getCompressedBinDepositAmountDecoder)())], ['decompressMultiplier', (0, kit_1.getU64Decoder)()]]);
}
function getAddLiquidityOneSidePreciseInstructionDataCodec() {
    return (0, kit_1.combineCodec)(getAddLiquidityOneSidePreciseInstructionDataEncoder(), getAddLiquidityOneSidePreciseInstructionDataDecoder());
}
function getAddLiquidityOneSidePreciseInstruction(input, config) {
    // Program address.
...
function parseAddLiquidityOneSidePreciseInstruction(instruction) {
...
//# sourceMappingURL=addLiquidityOneSidePrecise.js.map