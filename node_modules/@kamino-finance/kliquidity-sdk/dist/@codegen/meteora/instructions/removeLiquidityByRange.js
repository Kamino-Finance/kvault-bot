...
exports.REMOVE_LIQUIDITY_BY_RANGE_DISCRIMINATOR = void 0;
exports.getRemoveLiquidityByRangeDiscriminatorBytes = getRemoveLiquidityByRangeDiscriminatorBytes;
exports.getRemoveLiquidityByRangeInstructionDataEncoder = getRemoveLiquidityByRangeInstructionDataEncoder;
exports.getRemoveLiquidityByRangeInstructionDataDecoder = getRemoveLiquidityByRangeInstructionDataDecoder;
exports.getRemoveLiquidityByRangeInstructionDataCodec = getRemoveLiquidityByRangeInstructionDataCodec;
exports.getRemoveLiquidityByRangeInstruction = getRemoveLiquidityByRangeInstruction;
exports.parseRemoveLiquidityByRangeInstruction = parseRemoveLiquidityByRangeInstruction;
const kit_1 = require("@solana/kit");
const programs_1 = require("../programs");
const shared_1 = require("../shared");
exports.REMOVE_LIQUIDITY_BY_RANGE_DISCRIMINATOR = new Uint8Array([26, 82, 102, 152, 240, 74, 105, 26]);
function getRemoveLiquidityByRangeDiscriminatorBytes() { return (0, kit_1.fixEncoderSize)((0, kit_1.getBytesEncoder)(), 8).encode(exports.REMOVE_LIQUIDITY_BY_RANGE_DISCRIMINATOR); }
function getRemoveLiquidityByRangeInstructionDataEncoder() {
    return (0, kit_1.transformEncoder)((0, kit_1.getStructEncoder)([['discriminator', (0, kit_1.fixEncoderSize)((0, kit_1.getBytesEncoder)(), 8)], ['fromBinId', (0, kit_1.getI32Encoder)()], ['toBinId', (0, kit_1.getI32Encoder)()], ['bpsToRemove', (0, kit_1.getU16Encoder)()]]), (value) => ({ ...value, discriminator: exports.REMOVE_LIQUIDITY_BY_RANGE_DISCRIMINATOR }));
}
function getRemoveLiquidityByRangeInstructionDataDecoder() {
    return (0, kit_1.getStructDecoder)([['discriminator', (0, kit_1.fixDecoderSize)((0, kit_1.getBytesDecoder)(), 8)], ['fromBinId', (0, kit_1.getI32Decoder)()], ['toBinId', (0, kit_1.getI32Decoder)()], ['bpsToRemove', (0, kit_1.getU16Decoder)()]]);
}
function getRemoveLiquidityByRangeInstructionDataCodec() {
    return (0, kit_1.combineCodec)(getRemoveLiquidityByRangeInstructionDataEncoder(), getRemoveLiquidityByRangeInstructionDataDecoder());
}
function getRemoveLiquidityByRangeInstruction(input, config) {
    // Program address.
...
function parseRemoveLiquidityByRangeInstruction(instruction) {
...
//# sourceMappingURL=removeLiquidityByRange.js.map