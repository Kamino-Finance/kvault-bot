...
import { Account, Address, Instruction, type Option, Rpc, Slot, SolanaRpcApi, TransactionSigner } from '@solana/kit';
import { type GlobalConfig, type TermsSignature, type WhirlpoolStrategy } from './@codegen/kliquidity/accounts';
import Decimal from 'decimal.js';
import { type Position as OrcaPosition, type Whirlpool } from './@codegen/whirlpools/accounts';
...
import { type LbPair, type PositionV2 } from './@codegen/meteora/accounts';
...
export declare class Kamino {
    ...
    private readonly _kSwapBaseAPI;
     ...
     * @param jupBaseAPI
     */
    constructor(cluster: SolanaCluster, rpc: Rpc<SolanaRpcApi>, globalConfig?: Address, programId?: Address, whirlpoolProgramId?: Address, raydiumProgramId?: Address, meteoraProgramId?: Address, jupBaseAPI?: string, // unused, kept for backwards compatibility
    kSwapBaseAPI?: string, logger?: Logger);
     ...
     */
    getRebalanceTypeFromRebalanceFields: (rebalanceFields: RebalanceFieldInfo[]) => RebalanceType;
    /**
     ...
     * @param scopePrices
     */
    getStrategyShareData: (strategy: Address | StrategyWithAddress, scopePrices?: OraclePrices | Record<Address, OraclePrices>) => Promise<ShareData>;
    /**
     ...
     */
    getAllScopePriceFeedsForStrategy: (strategy: WhirlpoolStrategy, collateralInfos: CollateralInfo[]) => StrategyTokenScopeFeeds;
    private strategyTokenScopeFeedsToArray;
    private isOraclePricesAccount;
    private getUniqueScopeFeeds;
    private oraclePricesEntriesToMap;
    private getScopePricesMap;
    /**
     ...
     */
    legacyGetStrategiesShareData: (strategyFilters: StrategiesFilters | Address[], stratsWithAddresses?: StrategyWithAddress[], collateralInfos?: CollateralInfo[], disabledTokensPrices?: Map<Address, Decimal>) => Promise<Array<ShareDataWithAddress>>;
    /**
     ...
     */
    getAllPrices: (oraclePrices?: OraclePrices | Record<Address, OraclePrices> | [Address, OraclePrices][], collateralInfos?: CollateralInfo[], disabledTokensPrices?: Map<Address, Decimal>) => Promise<KaminoPrices>;
    /**
     ...
     * @param scopePrices
     */
    getStrategyPrices: (strategy: WhirlpoolStrategy, collateralInfos: CollateralInfo[], scopePrices?: OraclePrices | Record<Address, OraclePrices>, disabledTokensPrices?: Map<Address, Decimal>) => Promise<StrategyPrices>;
    /**
    ...
    getRaydiumAmmConfig: (config: Address) => Promise<import("./@codegen/raydium/accounts").AmmConfig | null>;
    /**
    ...
    getEventAuthorityPDA: (dex: bigint) => Promise<Option<Address>>;
    /**
     ...
     * @returns transaction instruction
     */
    initializeGlobalConfig: (owner: TransactionSigner, globalConfig: Address) => Instruction;
    /**
     ...
     * @returns transaction instruction
     */
    updateGlobalConfig: (owner: TransactionSigner, globalConfig: Address, globalConfigOption: GlobalConfigOption, index: number, value: bigint | Address | boolean) => Instruction;
    /**
     ...
     * @returns instruction to close the strategy
     */
    closeStrategy: (admin: TransactionSigner, strategy: Address | StrategyWithAddress) => Promise<import("./@codegen/kliquidity/instructions").CloseStrategyInstruction<Address, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, "TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA", string, string, "11111111111111111111111111111111", string, []>>;
     ...
     */
    openPosition: (admin: TransactionSigner, strategy: Address | StrategyWithAddress, positionMint: TransactionSigner, priceLower: Decimal, priceUpper: Decimal, status?: StrategyStatus) => Promise<Instruction>;
    /**
     * Get a transaction to open liquidity position for a Kamino strategy
     * @param strategy strategy you want to open liquidity position for
     ...
     */
    executiveWithdraw: (admin: TransactionSigner, strategy: Address | StrategyWithAddress, action: ExecutiveWithdrawAction) => Promise<Instruction>;
    /**
     ...
     */
    getUpdateReferencePriceTypeIx: (admin: TransactionSigner, strategy: Address | StrategyWithAddress, referencePriceType: ReferencePriceType) => Promise<Instruction>;
    /**
    ...
    getUpdateRebalancingParamsIxns: (strategyAdmin: TransactionSigner, strategy: Address | StrategyWithAddress, rebalanceParams: Decimal[], rebalanceType?: RebalanceType, tokenADecimals?: number, tokenBDecimals?: number) => Promise<Instruction>;
    getUpdateRebalancingParamsForUninitializedStratIx: (strategyAdmin: TransactionSigner, strategy: Address, rebalanceParams: Decimal[], rebalanceType: RebalanceType, tokenADecimals: number, tokenBDecimals: number) => Promise<Instruction>;
    ...
    getNewPositionRange(strategy: Address | StrategyWithAddress, rebalanceKind: RebalanceType, rebalanceParams: Decimal[]): Promise<PositionRange>;
     ...
     * @deprecated The method should not be used
     */
    getDepositRatioFromTokenA: (strategy: Address | StrategyWithAddress, amountA: bigint) => Promise<{
        amountSlippageA: bigint;
        amountSlippageB: bigint;
    }>;
    /**
     * @deprecated The method should not be used
     */
    getDepositRatioFromTokenB: (strategy: Address | StrategyWithAddress, amountB: bigint) => Promise<{
        amountSlippageA: bigint;
        amountSlippageB: bigint;
    }>;
    /**
