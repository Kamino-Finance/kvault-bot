...
function readTakeProfitRebalanceParamsFromStrategy(tokenADecimals, tokenBDecimals, rebalanceRaw) {
    ...
    const params = {};
    params['lowerRangePrice'] = lib_1.SqrtPriceMath.sqrtPriceX64ToPrice((0, raydiumBridge_1.toBN)((0, utils_1.readBigUint128LE)(buf, 0)), tokenADecimals, tokenBDecimals);
    params['upperRangePrice'] = lib_1.SqrtPriceMath.sqrtPriceX64ToPrice((0, raydiumBridge_1.toBN)((0, utils_1.readBigUint128LE)(buf, 16)), tokenADecimals, tokenBDecimals);
    params['destinationToken'] = new decimal_js_1.default(dv.getUint8(32));
    return params;
}
