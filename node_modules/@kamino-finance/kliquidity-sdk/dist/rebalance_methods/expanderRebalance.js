...
function readRawExpanderRebalanceParamsFromStrategy(rebalanceRaw) {
    ...
    const params = {};
    params['lowerRangeBps'] = new decimal_js_1.default(dv.getUint16(0, true));
    params['upperRangeBps'] = new decimal_js_1.default(dv.getUint16(2, true));
    params['lowerResetRatioBps'] = new decimal_js_1.default(dv.getUint16(4, true));
    params['upperResetRatioBps'] = new decimal_js_1.default(dv.getUint16(6, true));
    params['expansionBps'] = new decimal_js_1.default(dv.getUint16(8, true));
    params['maxNumberOfExpansions'] = new decimal_js_1.default(dv.getUint16(10, true));
    params['swapUnevenAllowed'] = new decimal_js_1.default(dv.getUint8(12));
    return params;
}
function readExpanderRebalanceParamsFromStrategy(rebalanceRaw) {
    const buf = new Uint8Array(rebalanceRaw.params);
    const dv = new DataView(buf.buffer, buf.byteOffset, buf.byteLength);
    const lowerRangeBps = new decimal_js_1.default(dv.getUint16(0, true));
    const upperRangeBps = new decimal_js_1.default(dv.getUint16(2, true));
    const lowerResetRatioBps = new decimal_js_1.default(dv.getUint16(4, true));
    const upperResetRatioBps = new decimal_js_1.default(dv.getUint16(6, true));
    const expansionBps = new decimal_js_1.default(dv.getUint16(8, true));
    const maxNumberOfExpansions = new decimal_js_1.default(dv.getUint16(10, true));
    const swapUnevenAllowed = new decimal_js_1.default(dv.getUint8(12));
    const lowerBpsRebalanceFieldInfo = {
        label: 'lowerRangeBps',
        type: 'number',
        value: lowerRangeBps,
...
function readRawExpanderRebalanceStateFromStrategy(rebalanceRaw) {
    ...
    const dv = new DataView(buf.buffer, buf.byteOffset, buf.byteLength);
    const state = {};
    state['initialPoolPrice'] = new decimal_js_1.default((0, utils_1.readBigUint128LE)(buf, 0).toString());
    state['expansionCount'] = new decimal_js_1.default(dv.getUint16(16, true));
    return state;
}
