...
function readPricePercentageWithResetRebalanceParamsFromStrategy(rebalanceRaw) {
    ...
    const lowerBpsRebalanceFieldInfo = {
        label: 'lowerRangeBps',
        type: 'number',
        value: new decimal_js_1.default(dv.getUint16(0, true)),
        enabled: true,
    };
    const upperBpsRebalanceFieldInfo = {
        label: 'upperRangeBps',
        type: 'number',
        value: new decimal_js_1.default(dv.getUint16(2, true)),
        enabled: true,
    };
    const resetLowerBpsRebalanceFieldInfo = {
        label: 'resetLowerRangeBps',
        type: 'number',
        value: new decimal_js_1.default(dv.getUint16(4, true)),
        enabled: true,
    };
    const resetUpperBpsRebalanceFieldInfo = {
        label: 'resetUpperRangeBps',
        type: 'number',
        value: new decimal_js_1.default(dv.getUint16(6, true)),
        enabled: true,
    };
    return [
        lowerBpsRebalanceFieldInfo,
