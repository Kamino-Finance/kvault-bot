...
function readAutodriftRebalanceParamsFromStrategy(rebalanceRaw) {
    ...
    const params = {};
    params['initDriftTicksPerEpoch'] = new decimal_js_1.default(dv.getUint32(0, true));
    params['ticksBelowMid'] = new decimal_js_1.default(dv.getInt32(4, true));
    params['ticksAboveMid'] = new decimal_js_1.default(dv.getInt32(8, true));
    params['frontrunMultiplierBps'] = new decimal_js_1.default(dv.getUint16(12, true));
    params['stakingRateASource'] = new decimal_js_1.default(dv.getUint8(14));
    params['stakingRateBSource'] = new decimal_js_1.default(dv.getUint8(15));
    params['initialDriftDirection'] = new decimal_js_1.default(dv.getUint8(16));
    return params;
}
function readRawAutodriftRebalanceStateFromStrategy(rebalanceRaw) {
    ...
    // prettier-ignore
    {
        ...
        [offset, state['last_window_epoch']] = [offset + 8, new decimal_js_1.default(dv.getBigUint64(offset, true).toString())];
        [offset, state['last_window_theoretical_tick']] = [offset + 4, new decimal_js_1.default(dv.getInt32(offset, true))];
        [offset, state['last_window_strat_mid_tick']] = [offset + 4, new decimal_js_1.default(dv.getInt32(offset, true))];
        ...
        [offset, state['current_window_epoch']] = [offset + 8, new decimal_js_1.default(dv.getBigUint64(offset, true).toString())];
        [offset, state['current_window_theoretical_tick']] = [offset + 4, new decimal_js_1.default(dv.getInt32(offset, true))];
        [offset, state['current_window_strat_mid_tick']] = [offset + 4, new decimal_js_1.default(dv.getInt32(offset, true))];
        [offset, state['autodrift_step']] = [offset + 1, new decimal_js_1.default(dv.getInt8(offset))];
    }
    return state;
}
