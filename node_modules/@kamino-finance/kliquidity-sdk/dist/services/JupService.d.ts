...
export declare class JupService {
    static getBestRouteV6: (userAddress: Address, amount: Decimal, inputMint: Address, outputMint: Address, slippageBps: number, asLegacyTransaction?: boolean, maxAccounts?: number, onlyDirectRoutes?: boolean, logger?: Logger) => Promise<SwapInstructionsResponse>;
    static getBestRouteQuoteV6: (amount: Decimal, inputMint: Address, outputMint: Address, slippageBps: number, asLegacyTransaction?: boolean, maxAccounts?: number, onlyDirectRoutes?: boolean, jupEndpoint?: string, logger?: Logger) => Promise<QuoteResponse>;
    static getSwapIxsFromQuote: (userAddress: Address, quote: QuoteResponse, wrapUnwrapSOL?: boolean, asLegacyTransaction?: boolean, logger?: Logger) => Promise<JupSwapInstructionsResponse>;
