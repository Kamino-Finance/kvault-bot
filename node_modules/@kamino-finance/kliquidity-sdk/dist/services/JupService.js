...
class JupService {
    ...
    static getBestRouteV6 = async (userAddress, amount, inputMint, outputMint, slippageBps, asLegacyTransaction, maxAccounts, onlyDirectRoutes, logger = console) => {
        try {
    ...
    static getBestRouteQuoteV6 = async (amount, inputMint, outputMint, slippageBps, asLegacyTransaction, maxAccounts, onlyDirectRoutes, jupEndpoint, logger = console) => {
        try {
            const params = {
                inputMint,
                outputMint,
    ...
    static getSwapIxsFromQuote = async (userAddress, quote, wrapUnwrapSOL = true, asLegacyTransaction, logger = console) => {
        try {
...
function transformResponseIx(ix) {
    return {
        data: ix.data ? (0, bytes_1.base64ToBytes)(ix.data) : undefined,
