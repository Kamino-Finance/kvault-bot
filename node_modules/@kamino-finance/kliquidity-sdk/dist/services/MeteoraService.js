...
const accounts_2 = require("../@codegen/meteora/accounts");
const codamaHelpers_1 = require("../utils/codamaHelpers");
const programs_1 = require("../@codegen/meteora/programs");
...
class MeteoraService {
    ...
    _meteoraApiUrl;
    _logger;
    constructor(rpc, meteoraProgramId = programs_1.LB_CLMM_PROGRAM_ADDRESS, logger = console) {
        this._rpc = rpc;
    ...
    async getPool(poolAddress) {
        return (0, codamaHelpers_1.unwrapAccount)(await (0, accounts_1.fetchMaybeLbPair)(this._rpc, poolAddress));
    }
    async getPosition(position) {
        return (0, codamaHelpers_1.unwrapAccount)(await (0, accounts_2.fetchMaybePositionV2)(this._rpc, position));
    }
    async getMeteoraPools() {
        const rawPools = await this._rpc
            .getProgramAccounts(programs_1.LB_CLMM_PROGRAM_ADDRESS, {
        ...
        for (let i = 0; i < rawPools.length; i++) {
            try {
                const compressedData = (0, bytes_1.base64ToBytes)(rawPools[i].account.data[0]);
                const decompressedData = (0, fzstd_1.decompress)(compressedData);
                const lbPair = (0, accounts_1.getLbPairDecoder)().decode(new Uint8Array(decompressedData));
