 ...
 */
export class ExchangeRateTrigger {
    name = 'exchange-rate-anomaly';
    previousRateByReserve = new Map();
    pendingRateByReserve = new Map();
    ...
    commitObservation(reserveAddress) {
        const reserveKey = reserveAddress.toString();
...
//# sourceMappingURL=exchangeRateTrigger.js.map